 ...
 */
'use strict';
// At first create addListener function => called twice
...
const resultSummaryQuerySelector = document.querySelector('#results-summary');
function resultSummary(tags, response) {
  resultSummaryQuerySelector.innerHTML = ''
    + '<p>'
